    ...
    $.fn.airStickyBlock = function(options){
        $.airStickyBlock = function($this, options){
            ...
            function setAmount(){
                ...
                stickyParentOffset = stickyParent.offset().top - 20;
                ...
                stickyStop = stopBlockHeight + stopBlockOffset - stickyHeight - 20;
                ...
                stickyAbsolute = stickyStop - stickyParentOffset - 40;
            } setAmount();
